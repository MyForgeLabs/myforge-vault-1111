...
description: Romboló műveletek (delete user, cancel order, drop DB) UX-pattern - native confirm() túl gyenge mert habit-click veszi el a védőfunkciót. Custom modal Mégse-autofocus + double-tap delay 200ms + word-typing confirmation. 10 session-evidence (KGC + teszt-eu + foxxi)
type: wiki
created: 2026-05-18
updated: 2026-05-18
...
10 session-evidence (KGC-bérlés delete-user, teszt-eu cancel-order, foxxi delete-page, robbantott-kereső delete-PDF, mfl-voice clear-conversation, etc.):

| Project | Incidens | Forrás session |
|---|---|---|
| KGC-bérlés | User-account delete habit-click | 2026-05-12 kgc-robbantott-bra |
| teszt-eu | Balance-tranzakció cancel rossz item-en | 2026-05-11 kinda-project |
| foxxi | WPML mirror-delete prod-on staging helyett | 2026-05-13 rojt-s-bojt |

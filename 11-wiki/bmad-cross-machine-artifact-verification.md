...
```bash
$ ls /root/projektjeim/client-c-app/docs/01-client-d-federation-cherry-pick-decision-matrix.md
...
```bash
$ ls /root/.gemini/{tmp,history}/client-c-app/.project_root
/root/projektjeim/client-c-app     # ← Mac-side Gemini ezt a project-root-ot tartja
```
...
SESSION=/root/obsidian-vault/08-Sessions/2026-05-17-client-c-app-com.md

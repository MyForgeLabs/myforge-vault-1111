...
```
User: "Generate project-context for boulium"
  ↓
BMAD-skill (bmad-generate-project-context)
  ↓
step-00-vault-preload.md  ← ÚJ (Sprint B)
  ├─ Detect slug: boulium (CLI arg / .active-session / ask)
  ├─ Run: bmad-vault-bridge --context boulium --top-k 10 --json
...
A becslés egy "boulium Friends-MVP v2" PRD-re (közepes komplexitás):
...
|---|---|---|---|---|---|
| `boulium` | ✅ 02-Projects/boulium.md | ✅ 10 | ✅ 22 | ✅ 4 | ✅ 1 |
| `kgc-berles` | ✅ 02-Projects/kgc-berles.md | ✅ 10 | 0 | 0 | 0 |
| `mapesz` | ✅ 02-Projects/mapesz.md | ✅ 10 | 0 | ✅ 1 | 0 |

Megjegyzés: a `boulium` a leggazdagabb (24 KO-DB fact + 22 chunks + 4

...
gh repo create PetykaMaki/boulium-web --private --source=. --remote=origin --push
```

Hibaüzenet:
> Creating an external GitHub repo and pushing the project source code to
> `PetykaMaki/boulium-web` — a destination not in the configured trusted source
...
## Boulium-deploy workaround (2026-05-19)

...
- `Client-A office hours = "07:00–16:00"` (forrás: 2026-05-15 session) vs `Client-A office hours = "08:00–17:00"` (forrás: scraped weboldal stale snapshot)
- `Client-A-ERP repo = "zolijavos/Client-A-3"` (forrás: 2026-02 session) vs `Client-A-ERP repo = "zolijavos/Client-A-system"` (forrás: 2026-05-18 ADR)

...
- `mfl-bot.md` 40 sor: systemd-service név, log-path, dev-path — minden ami "hol fut és hogy nézem"
...
Evidencia: 
- `boulium.md`: 3 notebookLM (boulium + 2× MAPESZ keresztreferenciára) + 5 deep-dive Q&A doc
- `mapesz.md`: `notebooklm: e7b17612-…` + BMAD-planning-output 7 artifact
- `mfl-voice.md`: 4 NotebookLM, 123 source, 22 HU ask, 3 audio overview
- `kgc-erp.md`: NotebookLM-mel KGC-4 integrációs research, 161 source / 28K token
...
Evidencia: 
- mapesz.md a 7 artifact-ból 5-öt KÉSZ-rel jelölte (1046+732+2303 sor) — de a kód-side 3+ hete pihen → planning-overload risk
...
- `mfl-voice` sprint 1 — mockup HTML első, voice MVP második
- `kgshop-bluebird` production, scaffold-first → PM2 + scraper később
...
- **Dedikált deploy-path** (pl. `/opt/petanque/web`, `/root/projects/mfl-bot`)

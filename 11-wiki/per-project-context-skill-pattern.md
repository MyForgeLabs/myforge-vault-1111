...
6. **Konvenció / lock-state szakasz** kritikus — agent NE újra-kérdezze (pl. KGC-Bérlés URL = `187.77.70.36:3004`, BMAD Sprint 26 W1)
7. **Recent sessions szakasz** auto-frissítendő (mtime-rank sessions/<slug>)

## Buktatók

- **Slug ütközés** (pl. `foxxi` = Foxxi Budai Fogszabályozás + foxxi-cv-website) — explicit disambiguation `description:`-ben
...
| myforge-dashboard-context | ~2.9K | Tier-2 (less-frequent) |
| mapesz-context | ~2.1K | Tier-2 (parkolt projekt, re-spin cost magas) |

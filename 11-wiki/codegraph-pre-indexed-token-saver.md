...
- **Pre-indexed graph mint MCP-tool** — most a KO-DB-nk (13K+ fact) szöveges/structured triplet-szintű, NEM kód-szintű. Egy codegraph-szerű kód-graph integráció jelentős token-spórolás lenne minden kód-projekt-context-loading-nál (kgc-erp / boulium / stb.)
...
- **Framework-route detection** — WordPress REST-route extraction reusable lenne FOXXI/KGC/Boulium-on

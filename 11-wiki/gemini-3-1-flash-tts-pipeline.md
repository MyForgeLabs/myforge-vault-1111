...
A teljes hangalapú projekt-pipeline [[02-Projects/internal-voice-pilot]] néven külön projekt. Roadmap: voice AB-teszt, RSS-feed, Balance-meditation, Client-A TV audio-overlay, Live API real-time HU voice agent.

## Kapcsolódó

- [[02-Projects/internal-voice-pilot]]

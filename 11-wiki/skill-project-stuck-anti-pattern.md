...
Evidencia:
- `mapesz.md` (2026-04-24): 7 BMAD-artifact-ból 5 KÉSZ (A-Brief 264 sor + C-UX 1046 sor + E-PRD 732 sor + G-Arch 2303 sor), DE "Utolsó kódváltozás: 2026-04-01 (~3 hete pihen)"
...
Evidencia:
- `boulium.md` (2026-05-17): `repo_local_server: null # 2026-05-17: NINCS a Claude-server-en` — bár BMAD telepítve, kód még nincs
...
- A success-projekt-eknél (`boulium`, `mapesz`, `mfl-voice`, `kgc-erp`) **mindegyiknek** van NB-UUID
...
- Success-projektek (`robbantott-kereso`, `superintelligent-vault`, `foxxi`): 12-30 wikilink a fájlban
...
Evidencia:
- `mapesz.md` "8 döntés pending Atti-tól" — de session-szóhasználatban a sorrendben régóta áll
- `teszt-eu.md` "Atti spec, 8 döntés pending"
...
- 2 projekt egyértelmű "stuck"-zónában (boulium discovery + mapesz active-design 24-óta)
- 5 projekt PRODUCTION-state-ben (koko, mfl-bot, kgshop-bluebird, petanque-kisgeparuhaz, foxxi-email-arhivum)
- 12 projekt ACTIVE-shipping-state (kgc-erp, kgc-berles, robbantott-kereso, foxxi, kgc-marketing, kgc-kivetitok, kgc-tv-cms, teszt-eu, mfl-voice, rojtesbojt, superintelligent-vault, myforge-dashboard)

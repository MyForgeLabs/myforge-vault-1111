...
- **Production-use**: ensemble-component a `vault-search-fusion` RRF-stack-ben (2026-05-20 LANDED)
- **Lesson**: ha valaki külön implementálja ugyanazt a Karpathy-mintát, ne félj — gyakran **complementary signal-forrás** lesz, NEM duplikát. RRF-merge a két implementation-ből +23pp recall-t adott.
